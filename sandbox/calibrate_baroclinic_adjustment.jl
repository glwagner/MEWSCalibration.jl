...
observations = SyntheticObservations(filepath; transformation, field_names)

coriolis = BetaPlane(; observations.metadata.coriolis...)

slice_ensemble_size = SliceEnsembleSize(size=(Ny, Nz), ensemble=Nens)
